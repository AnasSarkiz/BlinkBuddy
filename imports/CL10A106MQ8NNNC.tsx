...
export const CL10A106MQ8NNNC = (props: ChipProps<typeof pinLabels>) => {
	return (
		<chip
			pinLabels={pinLabels}
			supplierPartNumbers={{
			...
			manufacturerPartNumber="CL10A106MQ8NNNC"
			footprint={
				<footprint>
					<smtpad
						portHints={["pin2"]}
			...
			cadModel={{
				objUrl:
					"https://modelcdn.tscircuit.com/easyeda_models/assets/C1691.obj?uuid=ac9b32e974bc448eab36b1293f859dcb",
				stepUrl:
					"https://modelcdn.tscircuit.com/easyeda_models/assets/C1691.step?uuid=ac9b32e974bc448eab36b1293f859dcb",
				pcbRotationOffset: 0,
